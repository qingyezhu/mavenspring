...
public class TestHttpClientUtils {
	...
	public void testGetHttpResult() {
		...
		TestHttpClientUtils.logger.info(
				"TestHttpClientUtils testGetHttpResult url={},result={}", url,
				result);
	}
	...
	public void testGetFromJson() {
		...
		String result = HttpClientUtils.getHttpResult(url);
		TestHttpClientUtils.logger.info(
				"TestHttpClientUtils testGetHttpResult jsonValue[title]={}",
				JSONUtils.getFromJson(result, "weatherinfo"));
		TestHttpClientUtils.logger.info(
				"TestHttpClientUtils testGetHttpResult jsonValue[title]={}",
				JSONUtils.getFromJson(result, "weatherinfo", "city"));
	...
	public void testCreateXML() {
		...
		TestHttpClientUtils.logger.info("testCreateXML xmlStr:{}",

		XMLUtils.createXML("root", map));
	}
	...
	public void testReadFromXml() {
		...
		TestHttpClientUtils.logger.info("testCreateXML xmlStr:{}",
				XMLUtils.readFromXml(result, "city"));
	}
}