...
//	}
	...
	@Around(value = "execution(* com.wangzhu.service.SelfService.*(..))")
	public Object timeAroundSelfService(JoinPoint joinPoint) throws Throwable {
	...
	@Around(value = "execution(* com.wangzhu.service.IMyInterface.*(..))")
	public Object timeAroundMyInterface(JoinPoint joinPoint) throws Throwable {
		final String methodName = joinPoint.getSignature().getName();
		final Object[] args = joinPoint.getArgs();
		System.out.println(methodName + "======" + Arrays.toString(args));
		Object result = ((ProceedingJoinPoint) joinPoint).proceed();
